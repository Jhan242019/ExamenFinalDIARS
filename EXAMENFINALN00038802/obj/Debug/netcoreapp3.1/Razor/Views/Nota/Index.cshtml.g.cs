#pragma checksum "E:\ESTUDIOS\UPN\CICLO VII\DISEÑO Y ARQUITECTURA DE SOTFWARE\SEMANA 16\EXAMENFINALN00038802\EXAMENFINALN00038802\Views\Nota\Index.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "47b85c80ba29c756d5e7e6c28355ee69b9f45774"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"47b85c80ba29c756d5e7e6c28355ee69b9f45774", @"/Views/Nota/Index.cshtml")]
    ...
    public class Views_Nota_Index : global::Microsoft.AspNetCore.Mvc.Razor.RazorPage<dynamic>
    {
        ...
        {
            WriteLiteral(@"<h1 class=""text-center text-danger"">NOTAS</h1><div id=""nav"" class=""rounded-lg text-dark"" style=""background-color:black;"">    <a class=""float-right "" href=""#"" data-toggle=""modal"" data-target=""#crear"">        <div style=""margin:1.3rem 1rem 0rem 0rem"">            <svg width=""3em"" height=""3em"" viewBox=""0 0 16 16"" class=""bi bi-file-earmark-plus"" fill=""currentColor"" xmlns=""http://www.w3.org/2000/svg"">                <path d=""M4 0h5.5v1H4a1 1 0 0 0-1 1v12a1 1 0 0 0 1 1h8a1 1 0 0 0 1-1V4.5h1V14a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2V2a2 2 0 0 1 2-2z"" />                <path d=""M9.5 3V0L14 4.5h-3A1.5 1.5 0 0 1 9.5 3z"" />                <path fill-rule=""evenodd"" d=""M8 6.5a.5.5 0 0 1 .5.5v1.5H10a.5.5 0 0 1 0 1H8.5V11a.5.5 0 0 1-1 0V9.5H6a.5.5 0 0 1 0-1h1.5V7a.5.5 0 0 1 .5-.5z"" />            </svg>        </div>    </a>    <nav class=""navbar navbar-default"" role=""navigation"">        <div class=""navbar-header"">            <button type=""button"" class=""navbar-toggle"" data-toggle=""collapse"" data-target="".navbar-ex1-c");
...
#nullable restore
#line 25 "E:\ESTUDIOS\UPN\CICLO VII\DISEÑO Y ARQUITECTURA DE SOTFWARE\SEMANA 16\EXAMENFINALN00038802\EXAMENFINALN00038802\Views\Nota\Index.cshtml"
...
#nullable restore
#line 28 "E:\ESTUDIOS\UPN\CICLO VII\DISEÑO Y ARQUITECTURA DE SOTFWARE\SEMANA 16\EXAMENFINALN00038802\EXAMENFINALN00038802\Views\Nota\Index.cshtml"
                                                                          Write(eti.Nombre);

#line default
#line hidden
#nullable disable
            WriteLiteral("</a></li>\r                </ul>\r");
#nullable restore
#line 30 "E:\ESTUDIOS\UPN\CICLO VII\DISEÑO Y ARQUITECTURA DE SOTFWARE\SEMANA 16\EXAMENFINALN00038802\EXAMENFINALN00038802\Views\Nota\Index.cshtml"
            }

#line default
#line hidden
#nullable disable
            WriteLiteral(@"        </div>    </nav>    <div class=""text-center"">        <input id=""Nombre"" type=""search"" name=""search"" placeholder=""Buscar"" style=""background-size:cover; width:50%"">        <button class=""btn btn-primary"" style=""margin:0rem 1rem"" id=""buscar"" type=""submit""> Buscar</button>    </div></div><br /><div class=""form-group row"" id=""Lista""></div>");
            DefineSection("Scripts", async() => {
                WriteLiteral(@"    <script>        $.ajax({            url: '/Nota/Create',            type: 'get'        }).done(function (html) {            $('#crearNotita').html(html);        })        function submitFormCrear() {            $('#createNota').submit(); // aca busco y ejecuto el id del formulario, directamente            //$('#tomMuestra form').submit(); // con esta funcion, busco en el modal en el formulario y envio        }        function guardar(event) {            event.preventDefault();            var dataString = new FormData($('#crear form')[0]);            $.ajax({                url: ""/Nota/Create"",                type: ""post"",                processData: false,  // Important!                contentType: false,                cache: false,                data: dataString            }).done(function (html) {                location.reload();            }).fail(function (html) {                $('#crearNotita').html(html.responseText);            });        }    </script>    <scrip");
                WriteLiteral(@"t>        function init() {            $.ajax({                url: '/Nota/_Index?search=' + $('#Nombre').val()            }).done(function (notas) {                $('#Lista').html(notas);            });        }        $('#buscar').click(function (e) {            e.preventDefault();            init();        });        init();    </script>");
            }
            );
            WriteLiteral(@"<!-- Modal --><div class=""modal fade"" id=""crear"" tabindex=""-1"" aria-labelledby=""crear"" aria-hidden=""true"">    <div class=""modal-dialog"">        <div class=""modal-content"">            <div class=""modal-header"">                <h5 class=""modal-title"" id=""exampleModalLabel"">Crear Nota</h5>                <button type=""button"" class=""close"" data-dismiss=""modal"" aria-label=""Close"">                    <span aria-hidden=""true"">&times;</span>                </button>            </div>            <div class=""modal-body"" id=""crearNotita"">            </div>            <div class=""modal-footer"">                <button type=""button"" class=""btn btn-danger"" data-dismiss=""modal"">Cancelar</button>                <button type=""button"" class=""btn btn-success"" onclick=""submitFormCrear()"">Guardar</button>            </div>        </div>    </div></div>");
        }
